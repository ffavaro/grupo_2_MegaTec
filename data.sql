...
INSERT INTO products(id,name,price,discount,category_id,description,image,brand_id,stock) VALUES (1,'Procesador AMD RYZEN 3 3200G',629900,20,1,'Este procesador es ideal para jugadores y creadores de contenido que requieran un instrumento de gran ejecución, tiene memoria caché de 4 MB rápida y volátil. Procesador gráfico Radeon Vega 8 Graphics con potencia  de 65 W. Cuenta con 4 hilos que favorecen la ejecución de múltiples programas a la vez.','AMD-RYZEN-3-3200G.jpg',1,10);
INSERT INTO products(id,name,price,discount,category_id,description,image,brand_id,stock) VALUES (2,'Procesador AMD RYZEN 5 3400G',949900,10,1,'Este procesador es ideal para jugadores y creadores de contenido que requieran un instrumento de gran ejecución, tiene memoria caché de 4 MB, rápida y volátil. Procesador gráfico Radeon RX Vega 11 Graphic, con potencia de 65 W. Cuenta con 8 hilos que favorecen la ejecución de múltiples programas a la vez.','AMD-RYZEN-5-3400G-1.jpg',1,10);
INSERT INTO products(id,name,price,discount,category_id,description,image,brand_id,stock) VALUES (3,'Procesador Intel CORE ci5 7th',599900,30,1,'Este procesador brinda una experiencia perfecta y muy veloz gracias a los tiempos de arranque y la cpacidad de respuesta,tiene memoria de cache de 6 MB. CUneta con Intel HD Graphics 630, con potencia de 65 W.Cuenta con Hyper-Threading que favorece la ejecución de programas en simultáneo.','INTEL-Ci5-7th.jpg',2,10);
INSERT INTO products(id,name,price,discount,category_id,description,image,brand_id,stock) VALUES (4,'Procesador Intel CORE i5 10th',799900,20,1,'Este procesador ejecuta programas de edición de videos, creación de contenido, streaming y videojuegos sin afectar el rendimiento, tiene memoria caché de 12 MB. Procesador gráfico Intel UHD Graphics 630, con potencia  de 65 W. Cuenta con Hyper-Threading que favorece la ejecución de programas en simultáneo.','INTEL-Ci5-10th.jpg',2,10);
INSERT INTO products(id,name,price,discount,category_id,description,image,brand_id,stock) VALUES (5,'Procesador Intel CORE i9 12th',2799900,0,2,'Este procesador ejecuta programas de edición de videos, creación de contenido, streaming y videojuegos sin afectar el rendimiento, tiene memoria caché de 25 MB. Procesador gráfico Intel UHD Graphics 630, con potencia  de 125 W. Cuenta con Hyper-Threading que favorece la ejecución de programas en simultáneo.','INTEL-Ci9-12th.jpg',2,10);
INSERT INTO products(id,name,price,discount,category_id,description,image,brand_id,stock) VALUES (6,'Procesador AMD RYZEN 7 5800X',1699900,0,2,'Este procesador ofrece un rendimiento ultrarrápido de más de 100 FPS en los juegos más populares del mundo, tiene 8 núcleos y 16 hilos de procesamiento, basado en la arquitectura AMD Zen 3 4.6 GHz Max Boost, desbloqueado para overclocking, 36 MB de caché, soporte DDR4-3200.','AMD-RYZEN-7-5800x.jpg',1,10);
INSERT INTO products(id,name,price,discount,category_id,description,image,brand_id,stock) VALUES (7,'Procesador Intel CORE i7 12th',1799900,0,2,'Este procesador ofrece más espacio en caché y la arquitectura de hipersubprocesos con un alto rendimiento para aplicaciones exigentes con mejores gráficos y un impulso turbo más rápido, tiene 25 MB de caché L3 para aumentar el procesamiento de instrucciones y el rendimiento del sistema','INTEL-Ci7-12th.jpg',2,10);
INSERT INTO products(id,name,price,discount,category_id,description,image,brand_id,stock) VALUES (8,'Procesador AMD-RYZEN 9-5950X',1969000,20,2,'Este procesador ws ideal para jugadores y creadores de contenido que requieran un instrumento de gran ejecución, tiene memoria caché de 64 MB, rápida y volátil. Soporta memoria RAM DDR4, su potencia es de 105 W.Cuenta con 24 hilos que favorecen la ejecución de múltiples programas a la vez.','AMD-RYZEN-9-5950X.png',1,10);
